...
using Bau.ChessDataBase.Views.Files;

namespace Bau.ChessDataBase
{
	/// <summary>
	...
	public partial class MainWindow : Window
	{
		...
		{	
			...
			MainController = new Controllers.AppController("Bau.ChessDataBase", this, 
														   System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Bau.ChessDataBase"));
